...
public class CalendarPickerView extends ListView implements NestedScrollingChild {
    ...
    public enum SelectionMode {
        /**
         * Only one date will be selectable.  If there is already a selected date and you select a new one, the old date will be unselected.
         */
        SINGLE,
        /**
    ...
    /**
     * Both date parameters must be non-null and their {@link Date#getTime()} must not return 0. Time of day will be ignored.  For instance, if you pass in {@code minDate} as 11/16/2012 5:15pm and
     * {@code maxDate} as 11/16/2013 4:30am, 11/16/2012 will be the first selectable date and 11/15/2013 will be the last selectable date ({@code maxDate} is exclusive).
     * <p>
     * This will implicitly set the {@link SelectionMode} to {@link SelectionMode#SINGLE}.  If you want a different selection mode, use {@link FluentInitializer#inMode(SelectionMode)} on the {@link
     * FluentInitializer} this method returns.
     * <p>
     * The calendar will be constructed using the given time zone and the given locale. This means that all dates will be in given time zone, all names (months, days) will be in the language of the
     * locale and the weeks start with the day specified by the locale.
     *
     ...
     * FluentInitializer} this method returns.
     * <p>
     * The calendar will be constructed using the default locale as returned by {@link Locale#getDefault()} and default time zone as returned by {@link TimeZone#getDefault()}. If you wish the calendar
     * to be constructed using a different locale or time zone, use {@link #init(Date, Date, Locale)}, {@link #init(Date, Date, TimeZone)} or {@link #init(Date, Date, TimeZone, Locale)}.
     *
     * @param minDate Earliest selectable date, inclusive.  Must be earlier than {@code maxDate}.
     * @param maxDate Latest selectable date, exclusive.  Must be later than {@code minDate}.
     */
     ...
     * FluentInitializer} this method returns.
     * <p>
     * The calendar will be constructed using the given time zone and the default locale as returned by {@link Locale#getDefault()}. This means that all dates will be in given time zone. If you wish
     * the calendar to be constructed using a different locale, use {@link #init(Date, Date, Locale)} or {@link #init(Date, Date, TimeZone, Locale)}.
     *
     * @param minDate Earliest selectable date, inclusive.  Must be earlier than {@code maxDate}.
     * @param maxDate Latest selectable date, exclusive.  Must be later than {@code minDate}.
     */
     ...
     * FluentInitializer} this method returns.
     * <p>
     * The calendar will be constructed using the given locale. This means that all names (months, days) will be in the language of the locale and the weeks start with the day specified by the
     * locale.
     * <p>
     * The calendar will be constructed using the given locale and the default time zone as returned by {@link TimeZone#getDefault()}. This means that all names (months, days) will be in the language
     * of the locale and the weeks start with the day specified by the locale. If you wish the calendar to be constructed using a different time zone, use {@link #init(Date, Date, TimeZone)} or {@link
     * #init(Date, Date, TimeZone, Locale)}.
     *
     * @param minDate Earliest selectable date, inclusive.  Must be earlier than {@code maxDate}.
     * @param maxDate Latest selectable date, exclusive.  Must be later than {@code minDate}.
     */
    ...
    /**
     * Select a new date.  Respects the {@link SelectionMode} this CalendarPickerView is configured with: if you are in {@link SelectionMode#SINGLE}, the previously selected date will be un-selected.
     * In {@link SelectionMode#MULTIPLE}, the new date will be added to the list of selected dates.
     * <p>
     ...
     * <p>
     * Important: set this before you call {@link #init(Date, Date)} methods.  If called afterwards, it will not be consistently applied.
     */
